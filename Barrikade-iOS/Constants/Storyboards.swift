...
enum StoryboardScene {
  ...
  enum Main: StoryboardType {
    ...
    static let eventDetailsViewController = SceneType<Barrikade_iOS.EventDetailsViewController>(storyboard: Main.self, identifier: "EventDetailsViewController")

    static let eventViewController = SceneType<Barrikade_iOS.EventViewController>(storyboard: Main.self, identifier: "EventViewController")
